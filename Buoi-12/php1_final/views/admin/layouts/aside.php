    ...
    <nav class="navbar navbar-expand-xxl bg-light justify-content-center">
      ...
      <div class="navbar-logo">
        <a href="index.html">
          <img src="views/admin/layouts/assets/images/logo/logo.svg" alt="logo" />
        </a>
      </div>
      ...
      <div class="promo-box">
        <div class="promo-icon">
          <img class="mx-auto" src="views/admin/layouts/assets/images/logo/logo-icon-big.svg" alt="Logo">
        </div>
