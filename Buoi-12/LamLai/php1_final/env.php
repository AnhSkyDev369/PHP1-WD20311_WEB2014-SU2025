<?php
define('BASE_URL',                  'http://localhost/FPT-Code/WD20311_WEB2014/Buoi-12/LamLai/php1_final/'); // Định nghĩa URL gốc của website
...
define('DB_PASSWORD',               '');
define('DB_NAME',                   'php1_wd20311_php_final_lan1');

// Xong bước 1,2 với file env sửa path BASE_URL và DB_NAME