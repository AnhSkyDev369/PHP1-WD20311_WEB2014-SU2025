...
<body>
  <form action="#" method="">
    <!-- Form dùng để người dùng có thể tương tác (nhập, hiển thị)
        dữ liệu với server
        ...
        -   enctype: là kiểu mã hóa dữ liệu khi gửi đến server, có 2 kiểu mã hóa là application/x-www-form-urlencoded và multipart/form-data
...
// Muốn sử dụng SESSION thì phải có session_start() ở đầu file
// Cách sử dụng SESSION
// $_SESSION['ten_bien'] = 'giá trị của biến';
...
// Cách sử dụng COOKIE
// setcookie('ten_bien', 'giá trị của biến', time() + 3600, '/',...);
// Khai báo biến $name1
$name1 = "Nguyễn Thế Anh";
// Gán giá trị vào vùng cookie
$_COOKIE['ho_ten'] = $name1;
setcookie('ho_ten', $name1, time() + 1); // Tính bằng giây
